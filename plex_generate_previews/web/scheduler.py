...
def execute_scheduled_job(schedule_id: str, library_id: Optional[str] = None,
                          library_name: str = "", config: Optional[dict] = None) -> None:
    """
...
class ScheduleManager:
    ...
    def __init__(self, config_dir: str = '/config', run_job_callback: Optional[Callable] = None):
    ...
    def _update_last_run(self, schedule_id: str) -> None:
        ...
        if schedule_id in self._schedules:
            self._schedules[schedule_id]['last_run'] = datetime.utcnow().isoformat()
            self._save_schedules()
    
    def create_schedule(self, name: str, cron_expression: str = None,
                       interval_minutes: int = None, library_id: Optional[str] = None,
                       library_name: str = "", config: Optional[dict] = None,
    ...
    def update_schedule(self, schedule_id: str, name: str = None, cron_expression: str = None,
                       interval_minutes: int = None, library_id: str = None,
                       library_name: str = None, config: dict = None,
        ...
        if schedule['enabled']:
            ...
            job = self.scheduler.add_job(
                ...
                trigger=trigger,
                id=schedule_id,
                args=[schedule_id, schedule['library_id'], schedule['library_name'], schedule['config']],
                replace_existing=True
            )
