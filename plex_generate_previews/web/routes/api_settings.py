    ...
    return jsonify(
        {
            ...
            "credits_detection_enabled": settings.get("credits_detection_enabled", False),
            "credits_detection_overwrite": settings.get("credits_detection_overwrite", False),
            ...
            "intro_detection_overwrite": settings.get("intro_detection_overwrite", False),
