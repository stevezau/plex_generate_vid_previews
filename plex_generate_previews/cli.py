...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--gpu-threads", type=int, help="Number of GPU worker threads (default: 4)"
    )
    parser.add_argument(
        "--cpu-threads", type=int, help="Number of CPU worker threads (default: 4)"
    )
    parser.add_argument(
        "--gpu-selection",
...
def run_processing(
    config, selected_gpus, headless=False, progress_callback=None, worker_callback=None
):
